...
export default function ProcessSection() {
  return (
    <section id="our-process" className="py-24 md:py-32 bg-[#0a0a0a]">
          ...
          {steps.map((step, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-8 group hover:border-white/15 transition-all duration-500 hover:shadow-[0_8px_40px_rgba(0,0,0,0.3)]"
              >
