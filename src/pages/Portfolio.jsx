    ...
    <div className="pt-24 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <motion.p
          ...
          className="text-gray-400 max-w-2xl mx-auto mb-12 text-center"
        >
          Exciting projects coming soon — currently crafting high-converting websites for forward-thinking businesses
        </motion.p>
        ...
        >
          <div className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-12 text-center">
            ...
            <h3 className="text-xl font-semibold mb-3">Next Project: Coming Soon</h3>
            <p className="text-sm text-gray-400">Currently booking for April 2026 — reserve your spot</p>
          </div>
        </motion.div>
